...
<body>
    ...
    <a class="navbar-brand text-light" href="../index.php">Full Stack Eletro</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item active">
          <a class="nav-link text-light" href="../produtos.php">Produtos<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-light" href="../loja.php">Nossas lojas</a>
        </li>
        <li class="nav-item">
        ...
        <div class="container-fluid">
            ...
            <div class="produtos">
                ...
                <?php
                    ...
                    $dados_json = file_get_contents("http://localhost/Recode%20Pro/Atividade/Gilson_Vieira_de_Souza_projeto_pratico_fullstackeletro_Bootstrap/json/getContent.php?table=produto");
                    //var_dump($dados_json);

                    //$dados = json_decode($dados_json); //decodificando, porém cotinua sendo de origem json
                    $dados = json_decode($dados_json, true); //decodificando e passando para propriedade array
                ...
                ?>
                    <div class="box_produto" id="<?php echo $row['categoria'];?>" >
                        <img src="<?php echo "../".$row['imagem'];?>"  width="30%" onmouseover="destaque(this);" onmouseout="destaque(this);"> <!-- Passa o elemento como objeto--> 
                        <br>
                        <p class="descricao"><?php echo $row['descricao'];?></p>
                        <hr>
                        <p class="descricao"><strike>R$ <?php echo $row['preco'];?></strike></p>
                        <p class="preco">R$ <?php echo $row['precofinal'];?></p>
                    </div>
                <?php
                    }
                    // }else{
