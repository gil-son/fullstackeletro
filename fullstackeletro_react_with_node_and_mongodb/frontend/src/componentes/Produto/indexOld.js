                ...
                <div className="card-group">
                  ...
                  {this.state.db.map( //this.props.arrayProdutos.map
                    row=>
                         ...
                         { if(row.Categoria === this.state.categoria){
                            
                        return(
                            <div key={row.Id_Produto} className={`card card-produtos ${row.Categoria}`} onMouseOver={ (event) => this.Selecionar(event)}  onMouseOut={ (event) => {this.Desselecionar(event)}}>   
...
export class ExibirCategorias extends ExibirProdutos {
    ...
    return(
                <section className="categorias">                
                    ...
                    <ul className="list-group shadow-lg">
                      ...
                      <li className="list-group-item list-group-item-action" onClick={() => this.exibirGeladeira('geladeira')}>Geladeira (3)</li>
                      <li className="list-group-item list-group-item-action" >Fogões (2)</li>
